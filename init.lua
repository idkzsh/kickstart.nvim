...
vim.keymap.set('n', '<A-S-d>', 'yyp', { noremap = true, silent = true })

-- [[ Basic Autocommands ]]
--  See `:help lua-guide-autocommands`

-- Changing highlight colorscheme
...
vim.api.nvim_create_autocmd('TextYankPost', {
  ...
  callback = function()
    -- overriding the highlight group to visual to get the same colouring as visual mode
...
require('lazy').setup({
  ...
  {
    'kyazdani42/nvim-tree.lua', -- nvim-tree repository
    ...
    config = function()
      require('nvim-tree').setup {
        ...
        -- Refer to https://github.com/kyazdani42/nvim-tree.lua#setup for setup options
      }
    end,
  },
  {
  ...
  { -- LSP Configuration & Plugins
    ...
    dependencies = {
      ...
      { 'williamboman/mason.nvim', opts = { ensure_installed = { 'prettier' } }, dependenciesconfig = true }, -- NOTE: Must be loaded before dependants
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'typescript', 'css', 'astro' },
